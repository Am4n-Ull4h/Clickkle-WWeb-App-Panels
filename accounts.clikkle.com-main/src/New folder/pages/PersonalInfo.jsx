      ...
      <div className="flex flex-col mx-2">
        ...
        <div className="rounded border-gray-400 border-[1px] flex flex-col">
          ...
          <section className="flex justify-between pt-4 pb-2 px-2 border-t-[1px]">
              ...
              {isEditingName ? (
                <div className="flex items-center">
                  <input
                    ...
                    className="text-sm text-black px-2 py-1 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500 mr-2"
                  />
                  <input
                    type="text"
                    value={lastName}
            ...
            <h1 onClick={()=>setIsEditingName(true)} className="text-2xl cursor-pointer">
              &gt;
            </h1>
          </section>

          <section className="flex justify-between pt-4 pb-2 px-2 border-t-[1px]">
            <h1 className="text-sm">Birthday</h1>
            <div className="flex items-center">
              {isEditing ? (
                <div className="flex items-center">
                  <input
                ...
                <div className="flex items-center">
                  <h1 className="mr-10 text-sm">{birthdate}</h1>
                </div>
              )}
            </div>
            <h1 onClick={handleEditClick} className="text-2xl cursor-pointer">
              &gt;
            </h1>
          </section>
          ...
          <section className=" flex justify-between pt-4 pb-2 px-2 border-t-[1px]">
            ...
            <h1 className="mr-20 text-sm">{data.gender}</h1>
