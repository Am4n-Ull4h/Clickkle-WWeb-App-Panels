...
export default function Navbar(props) {
  ...
  const drawer = (
    ...
    >
      ...
      >
        <Image
          cdn="clikkle/logo/2023/clikkle-text.png"
          sx={{ height: "45px", paddingTop:"15px" }}
        />
        <Typography
          color="#737373"
          fontWeight="bold"
          sx={{ paddingLeft: "4px", paddingTop: "2px", fontSize: "1rem" }}
        >
          Clikkle
        </Typography>
        <Typography
        ...
        <Typography
          ...
          // variant="body2"
          fontWeight="bold"
          sx={{ position: "absolute", bottom: 2, left: "33%", fontSize:"12px" }}
        >
          Beta
        </Typography>
      </Box>
  ...
  const miniDrawer = (
    ...
    >
      <Box
        ...
        sx={{ textDecoration: "none", color: "text.primary", py: 1 }}
      >
        <Image cdn="clikkle/logo/2023/clikkle.png" sx={{ height: "50px" }} />
      </Box>
